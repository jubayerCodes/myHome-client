...
const Header = () => {
    ...
    return (
        <>
            <header className={`${scrolled ? 'xl:top-[-43px]' : ''} w-full duration-200 header xl:sticky top-0 left-0 bg-[#001a33] z-50 ${(pathname === '/') ? 'xl:bg-transparent xl:-mb-[126px]' : 'xl:bg-[var(--header-bg)]'}`}>
