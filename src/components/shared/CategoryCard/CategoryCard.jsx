...
const CategoryCard = ({ category }) => {
    ...
    return (
        <div style={{ backgroundImage: `url(${photo})` }} className={`h-[200px] md:h-[300px] bg-cover bg-no-repeat bg-center rounded-md overflow-hidden`}>
            <Link underline='none' href={`/properties?category=${name}`} className='hover:no-underline'>
